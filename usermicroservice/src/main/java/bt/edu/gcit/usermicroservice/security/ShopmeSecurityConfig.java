        ...
        SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                http
                                ...
                                .authorizeHttpRequests(configurer -> configurer
                                                ...
                                                .requestMatchers(HttpMethod.GET, "/api/users/checkDuplicateEmail")
                                                .hasAuthority("Admin")

                                                // 1. FIXED: Change these rules to use Ant Wildcard (**) patterns
                                                // instead of curly braces!
                                                .requestMatchers(HttpMethod.PUT, "/api/users/**").hasAuthority("Admin")
                                                .requestMatchers(HttpMethod.DELETE, "/api/users/**")
                                                .hasAuthority("Admin")

                                                // 2. FIXED: Change the enabled status path to use wildcards as well!
                                                .requestMatchers(HttpMethod.PUT, "/api/users/*/enabled").permitAll()
                                                ...
                                                .requestMatchers(HttpMethod.POST, "/api/states/**").permitAll()
